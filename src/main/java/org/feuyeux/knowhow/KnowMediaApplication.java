...
import org.feuyeux.knowhow.service.MediaCollector;
 ...
 */
@Slf4j
public class KnowMediaApplication {
    ...
    public static void main(String[] args) {
        ...
        MediaCollector.execute(srcPath, photoTargetPath, videoTargetPath, action == 0 ? Action.COPY : Action.MOVE);
    }
}
